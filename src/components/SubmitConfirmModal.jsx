...
export default function SubmitConfirmModal({
  ...
  summary,
  title = "Submit exam?",
  description = "Once submitted, you won't be able to change any answers. Here's a quick summary:",
  ...
  return (
    ...
    >
      <div className="space-y-4">
        ...
        {warningText && (
          <div className="flex items-start gap-2 text-xs text-navy-700 bg-navy-50 border border-navy-200 rounded-lg px-3 py-2.5">
            <AlertTriangle className="w-4 h-4 shrink-0 mt-0.5" />
            {warningText}
          </div>
        )}
